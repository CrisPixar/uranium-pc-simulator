...
def patch_arm64(data):
    ...
    cave(data, CAVE64_MON, b"".join([
        ...
        # b10: ветка "не песочница" обязана идти на POP (0x18), а не на ret (0x1C):
        # ret с LR=0x85da10 (затёрт bl get_Money) = вечный busy-loop -> фриз всей игры
        asm64("cbz w8, #0x%x" % (CAVE64_MON + 0x18), CAVE64_MON + 0x0C),
